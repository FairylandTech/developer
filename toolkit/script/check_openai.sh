...
# contribution: https://github.com/missuo/OpenAI-Checker
...
echo -e "${BLUE}OpenAI Access Checker. Made by Ace${PLAIN}"
echo -e "${BLUE}https://github.com/AceProfessional${PLAIN}"
echo "-------------------------------------"
if [[ $(curl -sS https://chat.openai.com/ -I | grep "text/plain") != "" ]]; then
