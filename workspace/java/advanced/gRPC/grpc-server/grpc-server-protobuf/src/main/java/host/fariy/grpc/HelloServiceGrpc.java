...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<host.fariy.grpc.HelloProto.HelloRequest,
      host.fariy.grpc.HelloProto.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = host.fariy.grpc.HelloProto.HelloRequest.class,
      responseType = host.fariy.grpc.HelloProto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<host.fariy.grpc.HelloProto.HelloRequest,
      host.fariy.grpc.HelloProto.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<host.fariy.grpc.HelloProto.HelloRequest, host.fariy.grpc.HelloProto.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<host.fariy.grpc.HelloProto.HelloRequest, host.fariy.grpc.HelloProto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  host.fariy.grpc.HelloProto.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  host.fariy.grpc.HelloProto.HelloResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<host.fariy.grpc.HelloProto.HelloRequest2,
      host.fariy.grpc.HelloProto.HelloResponse> getHello2Method;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello2",
      requestType = host.fariy.grpc.HelloProto.HelloRequest2.class,
      responseType = host.fariy.grpc.HelloProto.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<host.fariy.grpc.HelloProto.HelloRequest2,
      host.fariy.grpc.HelloProto.HelloResponse> getHello2Method() {
    io.grpc.MethodDescriptor<host.fariy.grpc.HelloProto.HelloRequest2, host.fariy.grpc.HelloProto.HelloResponse> getHello2Method;
    if ((getHello2Method = HelloServiceGrpc.getHello2Method) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHello2Method = HelloServiceGrpc.getHello2Method) == null) {
          HelloServiceGrpc.getHello2Method = getHello2Method =
              io.grpc.MethodDescriptor.<host.fariy.grpc.HelloProto.HelloRequest2, host.fariy.grpc.HelloProto.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello2"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  host.fariy.grpc.HelloProto.HelloRequest2.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  host.fariy.grpc.HelloProto.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(host.fariy.grpc.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<host.fariy.grpc.HelloProto.HelloResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getHelloMethod(), responseObserver);
    }

    /**
     */
    default void hello2(host.fariy.grpc.HelloProto.HelloRequest2 request,
        io.grpc.stub.StreamObserver<host.fariy.grpc.HelloProto.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void hello(host.fariy.grpc.HelloProto.HelloRequest request,
        io.grpc.stub.StreamObserver<host.fariy.grpc.HelloProto.HelloResponse> responseObserver) {
    ...
    /**
     */
    public void hello2(host.fariy.grpc.HelloProto.HelloRequest2 request,
        io.grpc.stub.StreamObserver<host.fariy.grpc.HelloProto.HelloResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class HelloServiceBlockingV2Stub
    ...
    /**
     */
    public host.fariy.grpc.HelloProto.HelloResponse hello(host.fariy.grpc.HelloProto.HelloRequest request) throws io.grpc.StatusException {
    ...
    /**
     */
    public host.fariy.grpc.HelloProto.HelloResponse hello2(host.fariy.grpc.HelloProto.HelloRequest2 request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
  ...
  public static final class HelloServiceBlockingStub
    ...
    /**
     */
    public host.fariy.grpc.HelloProto.HelloResponse hello(host.fariy.grpc.HelloProto.HelloRequest request) {
    ...
    /**
     */
    public host.fariy.grpc.HelloProto.HelloResponse hello2(host.fariy.grpc.HelloProto.HelloRequest2 request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getHello2Method(), getCallOptions(), request);
    }
  }
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<host.fariy.grpc.HelloProto.HelloResponse> hello(
        host.fariy.grpc.HelloProto.HelloRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<host.fariy.grpc.HelloProto.HelloResponse> hello2(
        host.fariy.grpc.HelloProto.HelloRequest2 request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((host.fariy.grpc.HelloProto.HelloRequest) request,
              (io.grpc.stub.StreamObserver<host.fariy.grpc.HelloProto.HelloResponse>) responseObserver);
          break;
        case METHODID_HELLO2:
          serviceImpl.hello2((host.fariy.grpc.HelloProto.HelloRequest2) request,
              (io.grpc.stub.StreamObserver<host.fariy.grpc.HelloProto.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              host.fariy.grpc.HelloProto.HelloRequest,
              host.fariy.grpc.HelloProto.HelloResponse>(
                service, METHODID_HELLO)))
        .addMethod(
          getHello2Method(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              host.fariy.grpc.HelloProto.HelloRequest2,
              host.fariy.grpc.HelloProto.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return host.fariy.grpc.HelloProto.getDescriptor();
    }
