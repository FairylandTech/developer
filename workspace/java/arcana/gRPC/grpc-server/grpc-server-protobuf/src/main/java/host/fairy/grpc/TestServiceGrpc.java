...
public final class TestServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<host.fairy.grpc.TestProto.TestRequest,
      host.fairy.grpc.TestProto.TestResponse> getTestMethodMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "testMethod",
      requestType = host.fairy.grpc.TestProto.TestRequest.class,
      responseType = host.fairy.grpc.TestProto.TestResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<host.fairy.grpc.TestProto.TestRequest,
      host.fairy.grpc.TestProto.TestResponse> getTestMethodMethod() {
    io.grpc.MethodDescriptor<host.fairy.grpc.TestProto.TestRequest, host.fairy.grpc.TestProto.TestResponse> getTestMethodMethod;
      ...
      synchronized (TestServiceGrpc.class) {
        if ((getTestMethodMethod = TestServiceGrpc.getTestMethodMethod) == null) {
          TestServiceGrpc.getTestMethodMethod = getTestMethodMethod =
              io.grpc.MethodDescriptor.<host.fairy.grpc.TestProto.TestRequest, host.fairy.grpc.TestProto.TestResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "testMethod"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  host.fairy.grpc.TestProto.TestRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  host.fairy.grpc.TestProto.TestResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void testMethod(host.fairy.grpc.TestProto.TestRequest request,
        io.grpc.stub.StreamObserver<host.fairy.grpc.TestProto.TestResponse> responseObserver) {
  ...
  public static final class TestServiceStub
    ...
    /**
     */
    public void testMethod(host.fairy.grpc.TestProto.TestRequest request,
        io.grpc.stub.StreamObserver<host.fairy.grpc.TestProto.TestResponse> responseObserver) {
  ...
  public static final class TestServiceBlockingV2Stub
    ...
    /**
     */
    public host.fairy.grpc.TestProto.TestResponse testMethod(host.fairy.grpc.TestProto.TestRequest request) throws io.grpc.StatusException {
  ...
  public static final class TestServiceBlockingStub
    ...
    /**
     */
    public host.fairy.grpc.TestProto.TestResponse testMethod(host.fairy.grpc.TestProto.TestRequest request) {
  ...
  public static final class TestServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<host.fairy.grpc.TestProto.TestResponse> testMethod(
        host.fairy.grpc.TestProto.TestRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TEST_METHOD:
          serviceImpl.testMethod((host.fairy.grpc.TestProto.TestRequest) request,
              (io.grpc.stub.StreamObserver<host.fairy.grpc.TestProto.TestResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              host.fairy.grpc.TestProto.TestRequest,
              host.fairy.grpc.TestProto.TestResponse>(
                service, METHODID_TEST_METHOD)))
        .build();
  }
  ...
  private static abstract class TestServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return host.fairy.grpc.TestProto.getDescriptor();
    }
