...
- [继承](src/main/java/org/example/extend/pkg1/Main.java)
- [多态](src/main/java/org/example/extend/pkg2/Main.java)
- [抽象类和抽象方法](src/main/java/org/example/extend/pkg3/Main.java)
- [接口](src/main/java/org/example/extend/pkg4/Main.java)
- [内部类](src/main/java/org/example/extend/pkg5/Main.java)

示例

1. [学生工具类](src/main/java/org/example/demo/demo1/StudentUtils.java), [测试](src/main/java/org/example/demo/demo1/Main.java)
2. [带有继承结构的JavaBean](src/main/java/org/example/extend/demo/demo1/Main.java)
3. [多态](src/main/java/org/example/extend/demo/demo2/Main.java)
